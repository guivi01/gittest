...
void CgittestDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CgittestDoc::InitializeSearchContent()
{
...
void CgittestDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
